...
bot = telebot.TeleBot('7270437364:AAHebfSzni6SiYxeIm7h-R6EuZtfkJPU-xU')
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < COOLDOWN_TIME:
                response = "You Are On Cooldown. Please Wait 0 sec Before Running The /attack1 Command Again buy premium instant attack with zero sec dm @SUKUNAA_XD."
                bot.reply_to(message, response, reply_markup=get_inline_keyboard())
                return
...
📩 <a https://t.me/+E376k1R35Xk3ZjA1 Owner</a> 💥
'''
